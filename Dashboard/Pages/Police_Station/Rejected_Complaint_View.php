<?php
    ...
    if(isset($_POST['btnactive']))
   {
	   ...
	   mysqli_query($con,$updateQ);
	     ...
	     $ntitle="Complaint ReActivated";
		 $ndes="Your Complaint ".substr($data['complaint_title'],0,10)."... dated on ".$data['complaint_date']." was ReActivated";
	     ...
	     mysqli_query($con,$insertNoti);
			...
			$mail->Body    = "Dear user, Your Complaint given in Crime Investigation Department is ReActivate";
	   ...
	   header("Location:Rejected_Complaints.php");
   }
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Rejected Complaints Details</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">Home</a></li>
                            <li><a href="#">Rejected Complaints</a></li>
                        </ol>
                    </div>
                </div>
            </div>
					...
					<div class="col-lg-7">
						<div class="card" style="height: 300px;">
							<div class="card-header">
								<strong>Rejected Complaints</strong> Details
							</div>
								...
								<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="card-footer">
									    <button type="submit" name="btnactive" class="btn btn-primary btn-sm">
											<i class="fa fa-dot-circle-o"></i> ReActivate
										</button>
