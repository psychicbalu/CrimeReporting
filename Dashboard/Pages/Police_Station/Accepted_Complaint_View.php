<?php
    ...
    if(isset($_POST['btnactive']))
   {
	   ...
	   mysqli_query($con,$updateQ);
	     ...
	     $ntitle="Complaint Completed";
		 $ndes="Your Complaint ".substr($data['complaint_title'],0,10)."... dated on ".$data['complaint_date']." was Successfully Completed";
		 $insertNoti="insert into tbl_notification(customer_id,n_title,n_des,status) values('".$data['customer_id']."','".$ntitle."','".$ndes."','0')";
	     mysqli_query($con,$insertNoti);
			...
			$mail->Body    = "Dear user, Your Complaint given in Crime Investigation Department is Completed";
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Accepeted Complaints Details</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">Home</a></li>
                            <li><a href="#">Accepeted Complaints</a></li>
                        </ol>
                    </div>
                </div>
            </div>
					...
					<div class="col-lg-7">
						<div class="card" style="height: 300px;">
							<div class="card-header">
								<strong>Accepeted Complaints</strong> Details
							</div>
								...
								<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="card-footer">
										<button type="submit" name="btnactive" class="btn btn-primary btn-sm">
											<i class="fa fa-dot-circle-o"></i> Completed
										</button>
										<button onclick="return confirm('Are You Sure?')" name="btndelete" class="btn btn-danger btn-sm">
											<i class="fa fa-ban"></i> Reject
										</button>
										<button onMouseOver="this.style.backgroundColor='#0c7810'" onMouseOut="this.style.backgroundColor='#119116'" class="btn btn-primary btn-sm" onclick="printDiv();" style="background-color: #119116;border-color: #119116;">
