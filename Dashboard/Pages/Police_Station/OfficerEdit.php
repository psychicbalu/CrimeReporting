<?php
   ...
   if(isset($_POST['btnsubmit']))
   {
	   ...
	   $updateQ="update tbl_officer_reg set officer_name='".$name."',officer_address='".$address."',officer_email='".$email."',officer_phno='".$phno."',des_id='".$des_id."' where officer_reg_id='".$oid."'";
							...
							<div class="card-body card-block">
								<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
									<div class="row form-group">
										...
										<div class="col-12 col-md-9"><input type="text" id="text-input" name="txtname" class="form-control" value="<?php echo $data['officer_name']; ?>" minlength="4" maxlength="50" style="text-transform: uppercase;" pattern="[A-Za-z\s]{4,50}" title="Enter Name(use A-Z or a-z)" required></div>
									</div>
									<div class="row form-group">
										<div class="col col-md-3"><label for="text-input" class=" form-control-label">Address</label></div>
										<div class="col-12 col-md-9"><textarea id="text-input" name="txtaddress"  cols="45" rows="5" class="form-control" minlength="10" maxlength="100" style="text-transform: capitalize;" pattern="[A-Za-z0-9\s]+{4,50}" title="Enter Address" required><?php echo $data['officer_address']; ?></textarea></div>
									</div>
									<div class="row form-group">
										<div class="col col-md-3"><label for="text-input" class=" form-control-label">Email</label></div>
										<div class="col-12 col-md-9"><input type="email" id="text-input" name="txtemail" class="form-control" value="<?php echo $data['officer_email']; ?>" minlength="4" maxlength="100" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}" title="Enter Email" required></div>
									</div>
									<div class="row form-group">
										<div class="col col-md-3"><label for="text-input" class=" form-control-label">Phone Number</label></div>
										<div class="col-12 col-md-9"><input type="text" pattern="[0-9]{5,10}" id="text-input" name="txtphno" class="form-control" value="<?php echo $data['officer_phno']; ?>" minlength="10" maxlength="10" pattern="[0-9]{10}" title="Enter PhoneNumber" required></div>
									</div>
									<div class="row form-group">
										...
										<select name="seldes" id="seldes"  class="form-control" title="Select Designation" required>
											...
											{
												?>
												<option value="<?php echo $data_des['des_id']; ?>" <?php if($data['des_id']== $data_des['des_id']){echo 'selected';}?> ><?php echo $data_des['des_name']; ?></option>
												<?php
											}
											?>
										  </select>
									...
									<div class="card-footer">
										...
										<button type="reset" class="btn btn-danger btn-sm" name="btncancel">
